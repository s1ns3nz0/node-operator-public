...
"$script" --aws-account-id 123456789012 --availability-zone ap-northeast-2a --availability-zone ap-northeast-2c --name hoodi-operator --backend-principal-arn arn:aws:iam::123456789012:role/NodeOperatorTerraformApply --github-repository example/operator --github-owner-id 101 --github-repository-id 102 --gitops-client-github-repository example/gitops --gitops-client-github-owner-id 103 --gitops-client-github-repository-id 104 --output-dir "$output" >/dev/null
