...
"$script" --aws-account-id 123456789012 --availability-zone ap-northeast-2a --availability-zone ap-northeast-2c --name hoodi-operator --backend-principal-arn arn:aws:iam::123456789012:role/NodeOperatorTerraformApply --output-dir "$output" >/dev/null
...
"$script" --aws-account-id 123456789012 --aws-region ap-northeast-1 --availability-zone ap-northeast-1a --availability-zone ap-northeast-1c --name hoodi-tokyo --backend-principal-arn arn:aws:iam::123456789012:role/NodeOperatorTerraformApply --output-dir "$scratch/tokyo" >/dev/null
